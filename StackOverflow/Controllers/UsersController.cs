...
namespace StackOverflow.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(StackOverflowContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,EmailAdress,Password,DateOfBirth,FirstName,LastName,University,GithubRating,CodeforcesRating,PhoneNumber,Adress,PointsAccumulated")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
